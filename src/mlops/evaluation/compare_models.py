...
def load_metrics(metrics_file: Path) -> list:
...
def create_comparison_plots(metrics: list, dataset: str, output_dir: Path) -> None:
...
def generate_report(titanic_metrics: list, house_metrics: list) -> str:
